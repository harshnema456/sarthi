              ...
              window.dispatchEvent(
                new CustomEvent("AI_FILES_READY", {
                  detail: {
                    ...
                    projectId: projectIdForFiles,
                  },
                })
              );

              // clear the ref so subsequent ops rely on current prop
              dashboardProjectIdRef.current = null;
            }
      ...
      >
        {!isUser && (
          <div className="mr-4 shrink-0">
            <div className="w-10 h-10 rounded-full overflow-hidden border border-slate-800">
              <Image src={avatarSrc} width={40} height={40} alt="ai-avatar" />
            </div>
          </div>
        )}
        ...
        {isUser && (
          <div className="ml-4 shrink-0">
            <div className="w-10 h-10 rounded-full overflow-hidden border border-slate-800">
              <Image src={avatarSrc} width={40} height={40} alt="you" />
            </div>
          </div>
        )}
      </div>
